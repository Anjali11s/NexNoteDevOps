...
import { Link, useNavigate, useParams } from "react-router"; // using react-router as you requested
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-amber-50 flex items-center justify-center">
        <LoaderIcon className="animate-spin size-10 text-amber-700" />
      </div>
    );
  }
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-2xl mx-auto">
          <div className="flex items-center justify-between mb-6">
            <Link to="/" className="btn btn-ghost text-amber-700">
              <ArrowLeftIcon className="h-5 w-5" />
              Back to Notes
            </Link>
            <button
              onClick={handleDelete}
              className="btn btn-outline text-red-600 border-red-400 hover:bg-red-50"
            >
